...
3. タイムスタンプ付きコメントが検出され、弾幕として表示される
4. コメント一覧からクリックでその時刻にジャンプ

## プロジェクト構成

```
youtube-danmaku-player-ext/
├── src/
│   ├── entrypoints/
│   │   ├── content/
...
│       └── renderer.ts         # 弾幕レンダリングエンジン（24fps, レーン管理）
